...
export declare const GetToolsCategoryParameterCategory: {
    readonly HRIS: "hris";
    readonly ATS: "ats";
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetHrisEmployeesParameterIncludeDeleted: {
    readonly TRUE: "true";
 ...
 * **(⚠️ Deprecated - Use the `employment_statuses` filter instead.)** Filter by the `employment_status` field.
 */
export declare const GetHrisEmployeesParameterEmploymentStatus: {
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetHrisEmployeeDocumentCategoriesParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetHrisTeamsParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetHrisGroupsParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetHrisEmploymentsParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetHrisLocationsParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetHrisAbsenceTypesParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetHrisTimeOffBalancesParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetHrisAbsencesParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetHrisLegalEntitiesParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetAtsApplicationsParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * **(⚠️ Deprecated - Use the `outcomes` filter instead.)** Filter applications by outcome. This allows you to get applications that are for example `PENDING`, `HIRED`, or `DECLINED`.
 */
export declare const GetAtsApplicationsParameterOutcome: {
    readonly PENDING: "PENDING";
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetAtsCandidatesParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetAtsTagsParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetAtsApplicationStagesParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetAtsJobsParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * **(⚠️ Deprecated - Use the `statuses` filter instead.)** Filter by the `status` field. Can be used to find a job based on its status.
 */
export declare const GetAtsJobsParameterStatus: {
    readonly OPEN: "OPEN";
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetAtsUsersParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetAtsOffersParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
 ...
 * By default, deleted entries are not returned. Use the `include_deleted` query param to include deleted entries too.
 */
export declare const GetAtsRejectionReasonsParameterIncludeDeleted: {
    readonly TRUE: "true";
    readonly FALSE: "false";
};
/**
...
export type PostConnectCreateLinkRequestBody = {
     ...
     */
    integration_tool?: 'personio' | 'workday' | 'workdaycustomreport' | 'workdaycustomreportsftp' | 'successfactors' | 'smartrecruiters' | 'factorial' | 'oraclerecruiting' | 'lever' | 'icims' | 'cornerstonetalentlink' | 'recruitee' | 'greenhouse' | 'greenhousejobboard' | 'teamtailor' | 'ashby' | 'talentsoft' | 'talentsoftcustomer' | 'concludis' | 'piloga' | 'onlyfy' | 'ukgpro' | 'adpworkforcenow' | 'rexx' | 'afas' | 'bamboohr' | 'bullhorn' | 'bullhornlogin' | 'workable' | 'payfitcustomer' | 'payfitpartner' | 'payfit' | 'jobvite' | 'employmenthero' | 'fountain' | 'kenjo' | 'heavenhr' | 'hibob' | 'softgarden' | 'cezannehr' | 'entraid' | 'azuread' | 'googleworkspace' | 'nmbrs' | 'pinpoint' | 'welcometothejungle' | 'dvinci' | 'join' | 'deel' | 'remotecom' | 'iriscascade' | 'okta' | 'sagehr' | 'sagepeople' | 'humaans' | 'traffit' | 'erecruiter' | 'eurecia' | 'abacusumantis' | 'umantis' | 'jobylon' | 'oraclehcm' | 'taleez' | 'officient' | 'sesamehr' | 'charliehr' | 'hrworks' | 'abacus' | 'otys' | 'zohopeople' | 'zohorecruit' | 'gusto' | 'breathehr' | 'catalystone' | 'mirus' | 'alexishr' | 'eploy' | 'jobdiva' | 'peple' | 'careerplug' | 'trinet' | 'paylocity' | 'paycor' | 'namely' | 'paycom' | 'insperity' | 'paychex' | 'avature' | 'rippling' | 'sapling' | 'heyrecruit' | 'peoplehr' | 'recruhr' | 'jazzhr' | 'lucca' | 'bite' | 'zelt' | 'planday' | 'boondmanager' | 'homerun' | 'haileyhr' | 'silae' | 'mysolution' | 'carerix' | 'hroffice' | 'talentclue' | 'inrecruiting' | 'ubeeo' | 'oysterhr' | 'kiwihr' | 'connexys' | 'hr4you' | 'cornerstoneondemand' | 'zvooverecruit' | 'square' | 'perbilityhelix' | 'comeet' | 'leapsome' | 'compleet' | 'datevhr' | 'datev' | 'datevlug' | 'sympa' | 'breezyhr' | 'flatchr' | 'applicantstack' | 'reachmee' | 'talentadore' | 'youforce' | 'nibelis' | 'sandbox' | 'guidecom' | 'sftp' | 'sftpfetch';
    /**
     * Language of the connection flow UI.
     */
    language?: 'en' | 'de' | 'fr' | 'it' | 'es';
