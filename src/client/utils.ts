 ...
 */
export const getParseAs = (contentType: string | null): Exclude<Config['parseAs'], 'auto' | 'stream'> => {
	if (!contentType) {
		return
	}
...
export const getAuthToken = async (security: Security, options: Pick<RequestOptions, 'accessToken' | 'apiKey'>): Promise<string | undefined> => {
