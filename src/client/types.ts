import type { BodySerializer, Middleware, QuerySerializer, QuerySerializerOptions } from './utils'
...
export type RequestResult<Data = unknown, TError = unknown, ThrowOnError extends boolean = boolean> = ThrowOnError extends true
	? Promise<{
			data: Data
			request: Request
			response: Response
...
export type OptionsLegacyParser<Data = unknown, ThrowOnError extends boolean = boolean> = Data extends { body?: any } ? (Data extends { headers?: any } ? OmitKeys<RequestOptions<ThrowOnError>, 'body' | 'headers' | 'url'> & Data : OmitKeys<RequestOptions<ThrowOnError>, 'body' | 'url'> & Data & Pick<RequestOptions<ThrowOnError>, 'headers'>) : Data extends { headers?: any } ? OmitKeys<RequestOptions<ThrowOnError>, 'headers' | 'url'> & Data & Pick<RequestOptions<ThrowOnError>, 'body'> : OmitKeys<RequestOptions<ThrowOnError>, 'url'> & Data
